/**
 * Login: email/password + Google. Link to signup and forgot password.
 */
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[var(--bg-primary)] p-4">
      <div className="w-full max-w-sm flex flex-col gap-6">
        <div className="text-center">
          <h1 className="text-2xl font-semibold text-white">AstroxAI</h1>
          <p className="text-[var(--text-muted)] text-sm mt-1">Sign in to continue</p>
        </div>
